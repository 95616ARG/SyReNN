...
image_file=$PWD/third_party/reluplex_model_checking/reluplex_bmc.tgz
specs_tgz=$PWD/third_party/reluplex_model_checking/specs.tgz
builddir=$BUILD_WORKING_DIRECTORY
outdir=$builddir/third_party/reluplex_model_checking
